"""FlashAttention-2 backward (dQ/dK/dV), validated against PyTorch autograd on
scaled_dot_product_attention. Also checks attn_fwd_l's L = log2-domain logsumexp vs numpy.
Run from kernels/:  python -m pytest attn_bwd/correctness/test_attn_bwd.py -v
"""
